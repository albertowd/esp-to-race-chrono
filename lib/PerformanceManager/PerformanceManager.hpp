#ifndef __PERFORMANCE_MANAGER_DEFAULT_HZ_HPP
#define __PERFORMANCE_MANAGER_DEFAULT_HZ_HPP

  #ifndef PERFORMANCE_MANAGER_DEFAULT_HZ
  #define PERFORMANCE_MANAGER_DEFAULT_HZ 25U
  #endif
...
#endif // __PERFORMANCE_MANAGER_DEFAULT_HZ_HPP
